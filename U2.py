...
if __name__=='_main__':
	...
	print 'listening on 127.0.0.1:6002'
	print 'wsdl is at: http://127.0.0.1:6002/SOAP/?wsdl'
	run_twisted( ( (wsgi_app, "SOAP"),), 6002)
if __name__=='__main__':  #发布服务
	try:
		...
		server = make_server('localhost', 6002, wsgi_application)
